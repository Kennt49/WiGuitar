        ...
        <section class="show-product">
          <article class="info-product">
            ...
            <div class="product-n-s">
              <div><p>{{$products->name}}</p></div>
              <div><p>id_stock : {{$stocks->nbr_products}}</p></div>
            </div>
            <div class="bc-description">
              <div><p>Description:</p></div>
              <div><p>{{$products->description}}</p></div>
            </div>
            <div class="product-p"><p>Prix : {{$products->price}}€</p></div>
            ...
            <div class="bc-caracteristique">
              <div><p>Caractéristiques:</p></div>
              <div>
                <ul>
                  <li>Fabricant : {{$features->maker}}</li>
                  <li>Matériel du corps : {{$features->body_material}}</li>
                  <li>Matériel du manche : {{$features->handle_material}}</li>
                  <li>Nombre de frettes : {{$features->number_frets}}</li>
                  <li>Nombre de cordes : {{$features->number_string}}</li>
                  <li>Réglage(s) : {{$features->setting}}</li>
                  <li>Switch micro : {{$features->switch_micro}}</li>
                </ul>
              </div>
            </div>
