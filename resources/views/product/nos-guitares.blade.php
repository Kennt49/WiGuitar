    ...
    <body>
      ...
      <main >
        <div class="btn-return">
          <a class="btn-return" href="../../Accueil"><p><- Retour</p></a>
        </div>
        <div class="style-guitar1">
          <div class="btn-style"><a href="/product/product-electrique"><p>Guitare Electrique</p></a></div>
          <div class="btn-style"><a href="/product/product-classique"><p>Guitare Classique</p></a></div>
        </div>
        <div class="style-guitar2">
          <div class="btn-style"><a href="/product/product-folk"><p>Guitare Folk</p></a></div>
        </div>
        <section>
